<template>
  <el-menu class="un-locker-menu" :default-active="selectedId" mode="vertical" @select="onSelect">
    <el-scrollbar>
      <el-menu-item-group v-if="props.lockers && props.lockers.length" title="Existing Lockers">
      ...
      <el-menu-item-group v-if="props.suggested && props.suggested.length" title="Suggested Lockers">
        <el-menu-item v-for="locker in props.suggested" :key="locker.id.toString(10)" :index="locker.id.toString(10)">
